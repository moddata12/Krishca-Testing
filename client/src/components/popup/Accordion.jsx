...
const MyAccordion = () => {
  ...
  const dg1RunningTime = millisecondsToDHMS(
    measurementData.totalTimeDifference11_13 || 0
  );
  const dg2RunningTime = millisecondsToDHMS(
    measurementData.totalTimeDifference12_13 || 0
  );
        ...
        <Accordion.Item eventKey="0" className="accordion-item">
          <Accordion.Header className="accordion-header">
            <h5 className="d-flex justify-content-center text-white bg-primary p-2 rounded">
              Consumption Time of DG in Site
            </h5>
          </Accordion.Header>
          <Accordion.Body>
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  <h6 className="bg-light p-3 text-dark rounded">
                    ...
                    {convertToIndianTime(measurementData.lastUpdatedMid11)}{" "}
                    <br />
                    Last updated time of Main MV Panel -{" "}
                    {convertToIndianTime(measurementData.lastUpdatedMid13)}{" "}
                    <br />
                    Total Running time of DG1 - {dg1RunningTime.days} days,{" "}
                    {dg1RunningTime.hours} hours, {dg1RunningTime.minutes}{" "}
              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  <h6 className="bg-light p-3 text-dark rounded">
                    ...
                    {convertToIndianTime(measurementData.lastUpdatedMid12)}{" "}
                    <br />
                    Last updated time of Main MV Panel -{" "}
                    {convertToIndianTime(measurementData.lastUpdatedMid13)}{" "}
                    <br />
                    Total Running time of DG2 - {dg2RunningTime.days} days,{" "}
                    {dg2RunningTime.hours} hours, {dg2RunningTime.minutes}{" "}
                    minutes, {dg2RunningTime.seconds} seconds
                  </h6>
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
